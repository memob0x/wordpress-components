...
add_action('rest_api_init', function () {
    ...
    // eg. http://localhost/wp-json/wcpt/v1/components/app-foobar
    register_rest_route('wcpt/v1', '/components/(?P<name>(the|app|base)(-[a-z]+)+).(?P<type>(' . WCPT_TYPE_ESM . '|' . WCPT_TYPE_SYSTEMJS . ')).js', array(
        'methods' => 'GET',
