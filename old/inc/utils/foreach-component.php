...
function wpcs_foreach_component($callable)
{
    ...
    foreach ($globs as $template_file_path) {
        ...
        $component_path_dist = wpcs_replace_src_with_dist($component_path_src);
        ...
        if (file_exists($component_js_system_file_path)) {
            $supported_js[] = array(
                ...
                'url' => wpcs_replace_path_with_uri($component_js_system_file_path)
            );
        }
        ...
        if (file_exists($component_js_esm_file_path)) {
            $supported_js[] = array(
                ...
                'url' => wpcs_replace_path_with_uri($component_js_esm_file_path)
            );
        }
        ...
        if (file_exists($component_css_file_path)) {
            $supported_css[] = array(
                ...
                'url' => wpcs_replace_path_with_uri($component_css_file_path)
            );
        }
        ...
        if (file_exists($component_css_critical_file_path)) {
            $supported_css[] = array(
                ...
                'url' => wpcs_replace_path_with_uri($component_css_critical_file_path)
            );
        }
        ...
        if (file_exists($template_file_path)) {
            $template_file_contents = wpcs_get_template_part_contents($template_file_path);
        }
